...
1. Hap1
                ...
                sbatch --partition=pibu_el8 --job-name=FrH1SAMTOOLS --time=0-21:00:00 --mem-per-cpu=64G --ntasks=48 --cpus-per-task=1 --output=FrHap1_SAMTOOLS.log --error=FrHap1_SAMTOOLS.err --mail-type=END,FAIL --wrap "cd /data/projects/p782_RNA_seq_Argania_spinosa/50_FinalArgan/04_RNAseqMapping/01_hap1/; module load SAMtools; samtools view --threads 48 -b -o Ufribourg_12samples_Hap1.bam Ufribourg_12samples_Hap1.sam; samtools sort -m 64G -o Ufribourg_12samples_Hap1_sorted.bam -T Ufribourg_12samples_Hap1_temp --threads 48 Ufribourg_12samples_Hap1.bam"
